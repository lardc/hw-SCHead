...
Int16S K_ShuntAmplifier = 0;
Int16S B_ShuntAmplifier = 0;
//
...
void Set_K_ShuntAmplifier1(float Ky)
{
  ...
  K_ShuntAmplifier = (Int16S)DataTable[REG_CS1_K1_I_CAL];
  ...
  if(Ky>=SHUNT_AMPLIFIER1_D2)
  {
    ...
    K_ShuntAmplifier = (Int16S)DataTable[REG_CS1_K2_I_CAL];
  ...
  if(Ky>=SHUNT_AMPLIFIER1_D3)
  {
    ...
    K_ShuntAmplifier = (Int16S)DataTable[REG_CS1_K3_I_CAL];
...
void Set_K_ShuntAmplifier2(float Ky)
{
  ...
  K_ShuntAmplifier = (Int16S)DataTable[REG_CS2_K1_I_CAL];
  ...
  if(Ky>=SHUNT_AMPLIFIER2_D2)
  {
    ...
    K_ShuntAmplifier = (Int16S)DataTable[REG_CS2_K2_I_CAL];
  ...
  if(Ky>=SHUNT_AMPLIFIER2_D3)
  {
    ...
    K_ShuntAmplifier = (Int16S)DataTable[REG_CS2_K3_I_CAL];
  ...
  if(Ky>=SHUNT_AMPLIFIER2_D4)
  {
    ...
    K_ShuntAmplifier = (Int16S)DataTable[REG_CS2_K4_I_CAL];
  ...
  if(Ky>=SHUNT_AMPLIFIER2_D5)
  {
    ...
    K_ShuntAmplifier = (Int16S)DataTable[REG_CS2_K5_I_CAL];
